# Iter72 post-place gate = check_f150_physical_islands.tcl with the pblock
# list changed for the Iter71 V2 floorplan (see apply_iter72_repin_islands.tcl).
#
...
# Iter72: the two Iter66e SLR1 cluster pblocks are replaced by one pblock of
# seven cluster instances (Iter71 V2).  Apply and check change together.
iter56_check_pblock pb_iter56_recurrent_slr2 SLR2 1
iter56_check_pblock pb_iter71_clusters_slr1 SLR1 7
iter56_check_pblock pb_iter56_result_boundary_slr1 SLR1 4

# Report where the free clusters 8/9/10 and their transport hierarchies
# actually land.  In Iter72 none of them is pinned (V2 left them free and they
# landed in SLR0/SLR2); these are observations, not placement constraints.
...
foreach actor_spec {
    {"*/grp_gdn_gemv_fu_*/gemv32_cluster2_8_U0" cluster8}
